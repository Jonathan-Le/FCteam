 ...
 * @author wang
 */
public class ManageEnterpriseJPanel extends JPanel implements ActionListener{
    JTable jtable;
    JScrollPane jsp;
...
//                    row[2]=request.getEnterpriseType();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        populateResearchTable(findAccount);
            ...
            addManageEnterprise ad = new addManageEnterprise(network);
    ...
    public void ShopView(){
		...
		p1_lab1 = new JLabel("Manage Enterprise please enter name");
		...
		p4_jb3 = new JButton("Manage Department");
