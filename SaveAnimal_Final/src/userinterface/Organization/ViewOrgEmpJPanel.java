 ...
 * @author junyaoli
 */
public class ViewOrgEmpJPanel extends javax.swing.JPanel {
   ...
   private JPanel userProcessContainer; 
    ...
    public ViewOrgEmpJPanel(JPanel userProcessContainer, EcoSystem system , Employee employee) {
        initComponents();
        this.userProcessContainer=userProcessContainer;
        this.system=system;
        this.employee=employee;   
        System.out.println(employee.getName());
        account=system.getUserAccountDirectory().findUserbyID(employee.getId());

            employeenamejTextField.setText(employee.getName());
            AgejTextField.setText(String.valueOf(employee.getAge()));
            genderjTextField.setText(employee.getSex());           
    ...
    private void initComponents() {
        ...
        add(employeenamejTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 160, -1));
        add(AgejTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 160, -1));
