 ...
 * @author wang
 */
public class OrganizationManagementJPanel11 extends JPanel implements ActionListener{
    ...
    public OrganizationManagementJPanel11(JPanel userProcessContainer, UserAccount account, EcoSystem business){
        this.initView();
