 ...
 * @author wang
 */
public class ApplyExaminationJPanel11 extends JPanel implements ActionListener{
    ...
    public ApplyExaminationJPanel11(JPanel userProcessContainer,EcoSystem business,UserAccount account,Enterprise userEnterprise){
        this.initView();
       ...
       List<Enterprise> Hos = business.getEnterpriseDirectory().getEnterpriseList();
        for (Enterprise hospital : Hos) {
             if (!hospital.getEnterpriseType().equals(Enterprise.EnterpriseType.RescuOrganization)) {
                    jcb1.addItem(hospital.getEnterpriseName());
                }     
        }
    }
    ...
    public void initView(){
        ...
        jp2 = new JPanel();
        jl1 = new JLabel("Medical Eamination Application");
        ...
        jb4 = new JButton("Send Application");
        jb4.addActionListener(this);
        jb4.setFont(MyTools.f1);
        
        jb5 = new JButton("View Application");
        jb5.addActionListener(this);
        jb5.setFont(MyTools.f1);
        
        jb6 = new JButton("Delete Application");
        jb6.addActionListener(this);
        jb6.setFont(MyTools.f1);
        
        jb7 = new JButton("Cancel Application");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == jb1){
            ...
            //Send Application
                String hospitalName=  jcb1.getSelectedItem().toString();
          String petName = jcb2.getSelectedItem().toString();
          ...
          ExaminationRequest e1 = new ExaminationRequest(title, pet);
          e1.setTitle(title);
          e1.setReceiver(hospital.getEnterpriseName());
          e1.setSender(userEnterprise.getEnterpriseName());
          e1.setStatus("Pending");
          hospital.getWorkQueue().getExaminationRequestList().add(e1);
          userEnterprise.getWorkQueue().getExaminationRequestList().add(e1);
          populateApplicationTable();
