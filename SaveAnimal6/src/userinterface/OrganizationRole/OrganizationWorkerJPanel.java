...
public class OrganizationWorkerJPanel extends JPanel implements ActionListener{
    ...
    public void initview(){
        ...
        jb2 = new JButton("Apply Euthanasia");
        jb2.setFont(MyTools.f1);
        jb2.addActionListener(this);
        
        
        jb3 = new JButton("MApply Medical Examination");
        jb3.setFont(MyTools.f1);
        jb3.addActionListener(this);
        
        jb4 = new JButton("Apply Medical Examination");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == jb1){
            ...
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            userProcessContainer.add(new ApplyEuthanasiaJPanel11(userProcessContainer,business,account,userEnterprise));
            layout.next(userProcessContainer); 
        }else if(e.getSource() == jb3){
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            userProcessContainer.add(new ApplyExaminationJPanel11(userProcessContainer,business,account,userEnterprise));
            layout.next(userProcessContainer);   
