 ...
 * @author wang
 */
public class ManageDepartmentJPanel extends JPanel implements ActionListener{
    JTable jtable;
    JScrollPane jsp;
    ...
    public void ShopView(){
		...
		p1_lab1 = new JLabel("Manage Department 请输入姓名（员工号或职位）");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //populateResearchTable(findAccount);
            ...
            addManageDepartment ad = new addManageDepartment(enterprise);
